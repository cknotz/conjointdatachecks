...
**Important**: The estimations do not take into account if the data are clustered. If the experiment involved multiple rounds of rating or choice tasks per respondents, the test should be run one round at a time.
